<script setup lang="ts" name="ServicePrivate">
...
function articleInfo() {
  articleInfoApi({ code: 'service_private' }).then((res) => {
...
<template>
  <div class="normal-page">
    <NormalHeader title="服务协议" bg-color="#000" text-color="#fff" :back-icon-tag="2">
    </NormalHeader>
